		...
		<div class="portlet-body form">
			<div class="form-body">
				...
				<div class="row">
					<div class="col-md-10">
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="id" type="text" value="<?php echo MRoom::getMax();?>"
				...
				<div class="row">
					<div class="col-md-10">
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="number" type="text" value="" class="form-control"
									name="MRoom[number]">
							</div>
					...
					<div class="col-md-10">
						<div class="form-group">
							<label class="control-label col-md-3">คณะ:<span
								class="required">*</span></label>
							<div class="col-md-6">
								<input id="building_id" type="text" value=""
				...
				<div class="row">
					...
					<div class="col-md-10">
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="building_id" type="text" value=""
									class="form-control" name="MRoom[building_id]">
							</div>
							<div id="divReq-building_id"></div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-10">
						<div class="form-group">
							<label class="control-label col-md-3">ชั้น:<span
								class="required">*</span></label>
							<div class="col-md-6">
								<input id="floor" type="text" value=""
									class="form-control" name="MRoom[floor]">
							</div>
							<div id="divReq-building_id"></div>
						</div>
					</div>
