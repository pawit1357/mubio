...
<form id="Form1" method="post" enctype="multipart/form-data"
	...
	<div class="<?php echo ConfigUtil::getPortletTheme(); ?>">
		<div class="portlet-title">
			...
			<div class="actions">
			<?php echo CHtml::link('ย้อนกลับ',array('PersonSpecialList/'),array('class'=>'btn btn-default btn-sm'));?>
			</div>
		</div>
							...
							<div class="row">
								<div class="col-md-10">
									<div class="form-group" id="divReq-title_id">
										...
										<div class="col-md-4">
											<select class="form-control select2" name="PersonSpecialList[title_id]"
												id="title_id">
									...
									<div class="form-group" id="divReq-position_id">
										...
										<div class="col-md-4">
											<select class="form-control select2"
												name="PersonSpecialList[position_id]" id="position_id">
												<option value="0">-- โปรดเลือก --</option>
									...
									<div class="form-group" id="divReq-firstname">
										...
										<div class="col-md-4">
											<input id="firstname" type="text" value="<?php echo $data->firstname;?>"
												class="form-control" name="PersonSpecialList[firstname]"> <span
									...
									<div class="form-group" id="divReq-surname">
										...
										<div class="col-md-4">
											<input id="surname" type="text" value="<?php echo $data->surname;?>" class="form-control"
												name="PersonSpecialList[surname]"> <span class="help-block"
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a class="accordion-toggle" data-toggle="collapse"
									...
									class="fa fa-balance-scale"></i> ความเชี่ยวชาญ
								</a>
							</h4>
						</div>
							...
							<div class="row">
								<div class="col-md-10">
									<div class="form-group" id="divReq-description">
										<label class="control-label col-md-4">ความเชี่ยวชาญ:<span
											class="required">*</span></label>
										<div class="col-md-4">
											<input id="description" type="text" value="<?php echo $data->desc;?>"
												class="form-control" name="PersonSpecialList[desc]"> <span
					...
					<div class="col-md-10">
						<div class="row">
							<div class="col-md-offset-3 col-md-10">
								...
								<?php echo CHtml::link(ConfigUtil::getBtnCancelButton(),array('PersonSpecialList/'),array('class'=>'btn btn-default uppercase'));?>
							</div>
						</div>
					</div>
