				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group" id="divReq-waste_code">
							...
							<div class="col-md-6">
								<input id="waste_code" type="text" value="" class="form-control"
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group" id="divReq-waste_type">
							...
							<div class="col-md-6">
								<input id="waste_type" type="text" value="" class="form-control"
					...
					<div class="col-md-6">
						<div class="form-group" id="divReq-container_type">
							<label class="control-label col-md-3">ประเภทภาชนะ:<span
								class="required">*</span></label>
							<div class="col-md-6">
								<input id="container_type" type="text" value=""
					...
					<div class="col-md-6">
						<div class="form-group" id="divReq-waste_volume">
							<label class="control-label col-md-3">ปริมาตร/น้ำหนัก:<span
								class="required">*</span></label>
							<div class="col-md-6">
								<input id="waste_volume" type="text" value=""
					...
					<div class="col-md-6">
						<div class="form-group" id="divReq-waste_room">
							<label class="control-label col-md-3">สถานที่เก็บ:<span
								class="required">*</span></label>
							<div class="col-md-6">
								<input id="waste_room" type="text" value="" class="form-control"
