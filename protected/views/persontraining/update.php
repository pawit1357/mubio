									...
									<div class="form-group" id="divReq-position_id">
										...
										<div class="col-md-4">
											<select class="form-control select2"
                                    			...
                                    			<option
													value="<?php echo $item->id?>"
													<?php echo ($item->id == $data->position_id? 'selected="selected"':'')?>><?php echo  $item->name?></option>
                                    			<?php }?>
									...
									<div class="form-group" id="divReq-firstname">
										...
										<div class="col-md-4">
											<input id="firstname" type="text"
												value="<?php echo $data->firstname;?>" class="form-control"
												name="PersonTraining[firstname]"> <span class="help-block"
												id="req-firstname"><?php echo Pathogen::$req1;?></span>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group" id="divReq-surname">
										...
										<div class="col-md-4">
											<input id="surname" type="text"
												value="<?php echo $data->surname;?>" class="form-control"
									...
									<div class="col-md-4">
										<select class="form-control select2"
											...
											<option value="0">-- โปรดเลือก --</option>
                                    			...
                                    			<option
												value="<?php echo $item->id?>" <?php echo ($item->id == $data->course_id? 'selected="selected"':'')?>><?php echo  $item->name?></option>
                                    			<?php }?>
