<form id="Form1" method="post" enctype="multipart/form-data"
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			...
			<div class="actions">
			<?php echo CHtml::link('ย้อนกลับ',array('MPosition/'),array('class'=>'btn btn-default btn-sm'));?>
			</div>
		</div>
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								...
								<?php echo CHtml::link(ConfigUtil::getBtnCancelButton(),array('MPosition/'),array('class'=>'btn btn-default uppercase'));?>
							</div>
						</div>
					</div>
