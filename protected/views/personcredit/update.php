...
<form id="Form1" method="post" enctype="multipart/form-data"
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			...
			<div class="actions">
			<?php echo CHtml::link('ย้อนกลับ',array('PersonCredit/'),array('class'=>'btn btn-default btn-sm'));?>
			</div>
		</div>
				...
				<div class="panel-group accordion" id="accordion1">
							...
							<div class="row">
								<div class="col-md-10">
									<div class="form-group" id="divReq-title_id">
										...
										<div class="col-md-4">
											<select class="form-control select2" name="PersonCredit[title_id]"
												id="title_id">
												<option value="0">-- โปรดเลือก --</option>
                                    			<?php foreach($titles as $item) {?>
                                    			<option
													value="<?php echo $item->id?>" <?php echo ($item->id == $data->title_id? 'selected="selected"':'')?>><?php echo  $item->name?></option>
                                    			<?php }?>
									...
									<div class="form-group" id="divReq-position_id">
										...
										<div class="col-md-4">
											<select class="form-control select2"
												name="PersonCredit[position_id]" id="position_id">
												<option value="0">-- โปรดเลือก --</option>
                                    			<?php foreach($positions as $item) {?>
                                    			<option
													value="<?php echo $item->id?>" <?php echo ($item->id == $data->position_id? 'selected="selected"':'')?>><?php echo  $item->name?></option>
                                    			<?php }?>
								...
								<div class="col-md-10">
									<div class="form-group" id="divReq-firstname">
										<label class="control-label col-md-4">ชื่อ:<span
											class="required">*</span></label>
										<div class="col-md-4">
											<input id="firstname" type="text" value="<?php echo $data->firstname;?>"
												class="form-control" name="PersonCredit[firstname]"> <span
								...
								<div class="col-md-10">
									<div class="form-group" id="divReq-surname">
										<label class="control-label col-md-4">นามสกุล:<span
											class="required">*</span></label>
										<div class="col-md-4">
											<input id="surname" type="text" value="<?php echo $data->surname;?>" class="form-control"
												name="PersonCredit[surname]"> <span class="help-block"
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a class="accordion-toggle" data-toggle="collapse"
									...
									class="fa fa-balance-scale"></i> วิทยากรทางด้าน
								</a>
							</h4>
						</div>
						...
						<div id="collapse_2" class="panel-collapse in">
							...
							<div class="row">
								<div class="col-md-10">
									<div class="form-group" id="divReq-credit">
										<label class="control-label col-md-4">วิทยากรทางด้าน:<span
											class="required">*</span></label>
										<div class="col-md-4">
											<input id="credit" type="text" value="<?php echo $data->credit;?>"
												class="grpOfInt form-control" name="PersonCredit[credit]"> <span
												class="help-block" id="req-credit"><?php echo Pathogen::$req1;?></span>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-md-10">
						<div class="row">
							<div class="col-md-offset-3 col-md-10">
								...
								<?php echo CHtml::link(ConfigUtil::getBtnCancelButton(),array('PersonCredit/'),array('class'=>'btn btn-default uppercase'));?>
							</div>
						</div>
					</div>
    ...
    jQuery(document).ready(function () {
    	...
    	$( "#Form1" ).submit(function( event ) {
         	...
         	if($("#credit").val().length==0){
        		$("#divReq-credit").closest('.form-group').addClass('has-error');
        		$("#req-credit").show();
        		$("#credit").focus();
        		return false;
            }else{
            	$("#divReq-credit").closest('.form-group').removeClass('has-error');
            	$("#req-credit").hide();
        	}
        	this.submit();
    	});
