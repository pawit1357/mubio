...
class PersonTraining extends CActiveRecord
{
    ...
    public function relations()
    {
        return array (
            ...
            'course' => array (self::BELONGS_TO,'MCourse','course_id' ),
    ...
    public function rules()
    {
        return array(
            array(
                'id,name,title_id,position_id,course_id,firstname,surname,result,create_date,create_by,update_date,update_by',
                'safe'
            )
        );
    }
