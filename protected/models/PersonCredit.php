...
class PersonCredit extends CActiveRecord
{
    ...
    public function rules()
    {
        return array(
            array(
                'id,name,title_id,position_id,firstname,surname,credit,create_date,create_by,update_date,update_by',
                'safe'
            )
        );
    }
